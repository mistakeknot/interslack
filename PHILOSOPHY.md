# interslack Philosophy

## Purpose
Slack integration for Claude Code — send messages, read channels, test integrations.

## North Star
Advance interslack through small, testable changes aligned to its core mission: Slack integration for Claude Code — send messages, read channels, test integrations.
